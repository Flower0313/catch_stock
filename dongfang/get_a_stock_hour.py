...
def get_all_kline_hour(str):
    ...
    params = {
        ...
        'fields2': 'f51,f53,f54,f55,f56,f57',
        'ndays': '1',
        'iscr': '0',
        'iscca': '0',
        '_': '1658678139590',
    ...
    base_sql_one_kline = '''
                insert into spider_base.df_a_stock_hour_kline(market,type,code,name,trendsTotal,preClose,trends,current_price,current_high,current_low,deal_amount,deal_vol) values("{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}")
            '''
    ...
    for i in result_json['trends']:
        trend_result = i.split(',')
        e_sql = base_sql_one_kline.format(result_json['market'], result_json['type'], result_json['code'],
                                          result_json['name'],
                                          result_json['trendsTotal'], result_json['preClose'], trend_result[0],
                                          trend_result[1], trend_result[2], trend_result[3], trend_result[4],
                                          trend_result[5])
...
if __name__ == '__main__':
    ...
    with ThreadPoolExecutor(20) as t:
        for r in result:
            t.submit(get_all_kline_hour, str=str(r[0]) + "." + str(r[1]))
